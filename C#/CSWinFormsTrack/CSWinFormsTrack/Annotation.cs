...
/***************************************************
* 날짜 : 2017.10.27
* 목표 : DZipper UI Design
         ******* 코멘트 *******
오늘은 간단하게 Form2 만들어서 UI 디자인만 하자.
대충 밑그림만 그린다는 식으로 컴포넌트 배치만 하고, 제대로된 속성 설정은 새로 프로젝트를 만들어서.
...
nf.Owner = this;
nf.Show();      // 새로운 폼 생성.
nf.ShowDialog();    // 기존 폼에 종속됨. 기존 폼에서 다른 작업 불가능.

새로 띄운 폼을 종료할 시점엔 this.close();를 하자.
