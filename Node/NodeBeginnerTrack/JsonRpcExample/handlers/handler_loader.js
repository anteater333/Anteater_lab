...
const handler_loader = {};

const handler_info = require('./handler_info');
const utils = require('jayson/lib/utils');


handler_loader.init = (jayson, app, api_path) => {
...
function initHandlers(jayson, app, api_path) {
	...
	const infoLen = handler_info.length;
	...
	app.post(api_path, (req, res, next) => {
